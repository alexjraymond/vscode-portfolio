...
<body>
    <div id="bio" className={styles.AboutPage}>
      <img src="https://i.imgur.com/zX3b9qj.png" />
        <div>Hello, my name is <strong>Alex Raymond</strong>. I am a passionate and innovative web developer with a rich academic background, holding a bachelor's degree in History and a double minor in Computer Science and Web Programming & Applications. My educational journey has equipped me with a unique perspective on tech and its historical context, enabling me to approach web development with a fresh and multifaceted mindset.</div>
